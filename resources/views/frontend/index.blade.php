...
<html>
  <head>
    ...
    <title>NAGIYD | responsive portfolio, Freelance, Nadjindo Fidèle</title>
    ...
    <!-- Font Awesome CSS-->
    <link rel="stylesheet" href="{{url('frontend/vendor/font-awesome/css/font-awesome.min.css')}}">
    <!-- Google fonts - Roboto + Roboto Slab-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto+Slab:400,700%7CRoboto:400,700,300">
    <!-- owl carousel-->
    <link rel="stylesheet" href="{{ url('frontend/vendor/owl.carousel/assets/owl.carousel.css') }}">
    <link rel="stylesheet" href="{{ url('frontend/vendor/owl.carousel/assets/owl.theme.default.css') }}">
    <!-- animate.css-->
    <link rel="stylesheet" href="{{ url('frontend/vendor/animate.css/animate.css') }}">
    <!-- theme stylesheet-->
  ...
  <body>
    ...
    <header class="header">
      <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container"><a href="#intro" class="navbar-brand scrollTo">Nagiyd</a>
          <button type="button" data-toggle="collapse" data-target="#navbarcollapse" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler navbar-toggler-right"><span class="fa fa-bars"></span></button>
          <div id="navbarcollapse" class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item"><a href="#intro" class="nav-link link-scroll">Accueil<span class="glyphicon glyphicon-home"></span></a></li>
    ...
    <!-- Intro Image-->
    @foreach ($ngd_homes as $item)
    <section id="intro" style="background: url({{ $item->image}}) center center no-repeat; background-size: cover;" class="intro-section pb-2">
      <div class="container text-center">
        <div data-animate="fadeInDown" class="logo"><img src="{{ $item->logo}}" alt="logo" width="130"></div>
        <h1 data-animate="fadeInDown" class="text-shadow mb-5">{{ $item->title }} !</h1>
        <p data-animate="slideInUp" class="h3 text-shadow text-400">
            {{ $item->description }}<br>
          I grind HTML and CSS and then weld them with PHP into beautiful and efficient websites.</p>
      </div>
    </section> 
    @endforeach
    ...
    <section id="about" class="about-section">
      <div class="container">            
          ...
          @foreach ($ngd_abouts as $ngd_about)
        
        <header class="text-center">
            
           
            
          <h2 data-animate="fadeInDown" class="title">{{$ngd_about->title}}</h2>
        ...
        <div class="row">
          ...
          <div data-animate="fadeInUp" class="col-sm-6 mx-auto mt-5"><img src="{{ url('frontend/img/about.jpg') }}" alt="This is me - IT worker" class="image rounded-circle img-fluid"></div>
        </div>
        @endforeach
      </div>
    </section>
    ...
    <section id="services" class="bg-gradient services-section">
      <div class="container">
        ...
        <header class="text-center"> 
           <h2 data-animate="fadeInDown" class="title">Nos Services</h2>
        </header>
       
        <div class="row services text-center">
            @foreach ($ngd_services as $ngd_service)
           
           <div data-animate="fadeInUp" class="col-lg-4">
                <div class="icon"><i class="fa fa-search"></i></div>
                <h3 class="heading mb-3 text-400">{{ $ngd_service->title }}</h3>
                <p class="text-left description">
                    {{ $ngd_service->description }}
                </p>  
            </div>
        ...
        <ul data-animate="fadeInUp" class="owl-carousel owl-theme testimonials equalize-height">
          <li class="item">
            <div class="testimonial full-height">
              ...
              <div class="bottom">
                ...
                <div class="name-picture"><img alt="" src="{{ url('frontend/img/person-1.jpg') }}">
                  <h5>John McIntyre</h5>
                  <p>CEO, TransTech</p>
                </div>
              </div>
          ...
          <li class="item">
            <div class="testimonial full-height">
              ...
              <div class="bottom">
                <div class="icon"><i class="fa fa-quote-left"></i></div>
                <div class="name-picture"><img alt="" src="{{ url('frontend/img/person-2.jpg') }}">
                  <h5>John McIntyre</h5>
                  <p>CEO, TransTech</p>
                </div>
              </div>
          ...
          <li class="item">
            <div class="testimonial full-height">
              ...
              <div class="bottom">
                <div class="icon"><i class="fa fa-quote-left"></i></div>
                <div class="name-picture"><img alt="" src="{{ url('frontend/img/person-3.jpg') }}">
                  <h5>John McIntyre</h5>
                  <p>CEO, TransTech</p>
                </div>
              </div>
          ...
          <li class="item">
            <div class="testimonial full-height">
              ...
              <div class="bottom">
                <div class="icon"><i class="fa fa-quote-left"></i></div>
                <div class="name-picture"><img alt="" src="{{ url('frontend/img/person-4.jpg') }}">
                  <h5>John McIntyre</h5>
                  <p>CEO, TransTech</p>
                </div>
              </div>
    ...
    <!-- Statistics-->
    <section id="statistics" data-dir="up" style="background: url(&quot;frontend/img/parallax.jpg&quot;);" class="statistics-section text-white parallax parallax">
      <div class="container">
    ...
    *** REFERENCES IMAGE ***
          ...
          <div id="references-masonry" data-animate="fadeInUp">
            <div class="row">
                  <div data-category="webdesign" class="reference-item col-lg-3 col-md-6">
                    <div class="reference"><a href="#"><img src="{{ url('frontend/img/portfolio-1.jpg') }}" alt="" class="img-fluid">
                        <div class="overlay">
                          <div class="inner">
                      ...
                      <div data-images="frontend/img/main-slider1.jpg,frontend/img/main-slider2.jpg,frontend/img/main-slider3.jpg" class="sr-only reference-description">
                  ...
                  <div data-category="seo" class="reference-item col-lg-3 col-md-6">
                    <div class="reference"><a href="#"><img src="{{ url('frontend/img/portfolio-2.jpg') }}" alt="" class="img-fluid">
                        <div class="overlay">
                          <div class="inner">
                      ...
                      <div data-images="frontend/img/main-slider3.jpg,frontend/img/main-slider1.jpg" class="sr-only reference-description">
                        <p>Projecting surrounded literature yet delightful alteration but bed men. Open are from long why cold. If must snug by upon sang loud left. As me do preference entreaties compliment motionless ye literature. Day behaviour explained law remainder. Produce can cousins account you pasture. Peculiar delicate an pleasant provided do perceive.</p>
                        <p>Sitting mistake towards his few country ask. You delighted two rapturous six depending objection happiness something the. Off nay impossible dispatched partiality unaffected. Norland adapted put ham cordial. Ladies talked may shy basket narrow see. Him she distrusts questions sportsmen. Tolerably pretended neglected on my earnestly by. Sex scale sir style truth ought.</p>
                        <p class="buttons text-center"><a href="javascript:void(0);" class="btn btn-outline-primary"><i class="fa fa-globe"></i> Visit website</a><a href="javascript:void(0);" class="btn btn-outline-primary"><i class="fa fa-download"></i> Download case study</a></p>
                      </div>
                  ...
                  <div data-category="marketing" class="reference-item col-lg-3 col-md-6">
                    <div class="reference"><a href="#"><img src="frontend/img/portfolio-3.jpg" alt="" class="img-fluid">
                        <div class="overlay">
                          <div class="inner">
                  ...
                  <div data-category="marketing" class="reference-item col-lg-3 col-md-6">
                    <div class="reference"><a href="#"><img src="{{ url('frontend/img/portfolio-4.jpg') }}" alt="" class="img-fluid">
                        <div class="overlay">
                          <div class="inner">
                  ...
                  <div data-category="webdesign" class="reference-item col-lg-3 col-md-6">
                    <div class="reference"><a href="#"><img src="{{url('frontend/img/portfolio-5.jpg')}}" alt="" class="img-fluid">
                        <div class="overlay">
                          <div class="inner">
                  ...
                  <div data-category="other" class="reference-item col-lg-3 col-md-6">
                    <div class="reference"><a href="#"><img src="{{url('frontend/img/portfolio-6.jpg')}}" alt="" class="img-fluid">
                        <div class="overlay">
                          <div class="inner">
                  ...
                  <div data-category="seo" class="reference-item col-lg-3 col-md-6">
                    <div class="reference"><a href="#"><img src="{{url('frontend/img/portfolio-7.jpg')}}" alt="" class="img-fluid">
                        <div class="overlay">
                          <div class="inner">
                            <h3 class="h4 reference-title">Project name</h3>
                            <p>Short project description goes here...</p>
                  ...
                  <div data-category="webdesign" class="reference-item col-lg-3 col-md-6">
                    <div class="reference"><a href="#"><img src="{{url('frontend/img/portfolio-8.jpg')}}" alt="" class="img-fluid">
                        <div class="overlay">
                          <div class="inner">
                            <h3 class="h4 reference-title">Project name</h3>
                            <p>Short project description goes here...</p>
        ...
        <div class="col-md-12">
          <div class="row align-items-center">
            <div class="col-lg-2 col-md-4 col-sm-6">
              <div class="customer"><img src="{{url('frontend/img/customers/logo-1.svg')}}" title="brand logo" data-placement="bottom" data-toggle="tooltip" alt="" class="img-fluid d-block mx-auto"></div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
              <div class="customer"><img src="{{url('frontend/img/customers/logo-2.svg')}}" title="brand logo" data-placement="bottom" data-toggle="tooltip" alt="" class="img-fluid d-block mx-auto"></div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
              <div class="customer"><img src="{{url('frontend/img/customers/logo-3.svg')}}" title="brand logo" data-placement="bottom" data-toggle="tooltip" alt="" class="img-fluid d-block mx-auto"></div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
              <div class="customer"><img src="{{url('frontend/img/customers/logo-4.svg')}}" title="brand logo" data-placement="bottom" data-toggle="tooltip" alt="" class="img-fluid d-block mx-auto"></div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
              <div class="customer"><img src="{{url('frontend/img/customers/logo-5.svg')}}" title="brand logo" data-placement="bottom" data-toggle="tooltip" alt="" class="img-fluid d-block mx-auto"></div>
            </div>
            <div class="col-lg-2 col-md-4 col-sm-6">
              <div class="customer"><img src="{{url('frontend/img/customers/logo-6.svg')}}" title="brand logo" data-placement="bottom" data-toggle="tooltip" alt="" class="img-fluid d-block mx-auto"></div>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="controls">
                <div class="row">
                  <div class="col-md-6" {{ $errors->has('FirstName') ? ' has-error' : '' }}>
                    <input type="text" name="FirstName" placeholder="Prénom *" required="required" class="form-control">
                  ...
                  <div class="col-md-6" {{ $errors->has('LastName') ? ' has-error' : '' }}>
                    <input type="text" name="LastName" placeholder="Nom *" required="required" class="form-control">
                  ...
                  <div class="col-md-6" {{ $errors->has('email') ? ' has-error' : '' }}>
                    <input type="text" name="email" placeholder="Votre email *" required="required" class="form-control">
                  ...
                  <div class="col-md-6" {{ $errors->has('phone') ? ' has-error' : '' }}>
                    <input type="text" name="phone" placeholder="Votre Téléphone" class="form-control">
                  ...
                  <div class="col-md-12" {{ $errors->has('message') ? ' has-error' : '' }}>
                    <textarea name="message" placeholder="Votre Message *" rows="4" required="required" class="form-control"></textarea>
    ...
    <script src="{{ url('frontend/vendor/waypoints/lib/jquery.waypoints.min.js') }}"></script>
    <script src="{{ url('frontend/vendor/jquery.counterup/jquery.counterup.js') }}"></script>
